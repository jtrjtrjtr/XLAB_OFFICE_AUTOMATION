...
- Formát: 13 slajdů, na šířku, 16:9 (960 × 540 pt)
...
| `img/` | Ukázkové motivy selfie zdi vložené do slajdu 7 (base64 při buildu). |
...
for ph, f in [("__IMG_PRVOREP__","img/meating_Prvorepublikovy.jpg"), ("__IMG_COMIC__","img/meating_Comic.jpg"), ("__IMG_KRK__","img/meating_Krkovicka.jpg"), ("__IMG_BUD__","img/meating_Budoucnost.jpg")]:
